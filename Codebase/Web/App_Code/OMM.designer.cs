...
public partial class ClientContact : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Association(Name="Country_ClientContact1", Storage="_Country1", ThisKey="CountryID", OtherKey="ID", IsForeignKey=true)]
		...
		set
		{
						...
						|| (this._Country1.HasLoadedOrAssignedValue == false)))
			{
				...
				if ((previousValue != null))
				{
					...
					previousValue.ClientContacts1.Remove(this);
				}
				this._Country1.Entity = value;
				if ((value != null))
				{
					value.ClientContacts1.Add(this);
					this._CountryID = value.ID;
				}
				else
				{
...
public partial class Country : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	private EntitySet<ClientContact> _ClientContacts1;
	...
	public Country()
	{
		...
		this._ClientContacts1 = new EntitySet<ClientContact>(new Action<ClientContact>(this.attach_ClientContacts1), new Action<ClientContact>(this.detach_ClientContacts1));
		OnCreated();
	}
	...
	[Association(Name="Country_ClientContact1", Storage="_ClientContacts1", ThisKey="ID", OtherKey="CountryID")]
	public EntitySet<ClientContact> ClientContacts1
	{
		get
		{
			return this._ClientContacts1;
		}
		set
		{
			this._ClientContacts1.Assign(value);
		}
	}
	...
	private void attach_ClientContacts1(ClientContact entity)
	{
		this.SendPropertyChanging();
		entity.Country1 = this;
	}
	
	private void detach_ClientContacts1(ClientContact entity)
	{
		this.SendPropertyChanging();
