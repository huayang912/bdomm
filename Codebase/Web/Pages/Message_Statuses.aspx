...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContentPlaceHolder" runat="Server">
  ...
  <div factory:flow="NewRow" style="padding-top:8px" xmlns:factory="urn:codeontime:app-factory">
    <div factory:activator="Tab|Message Recipients">
      ...
      <aquarium:DataViewExtender id="view2Extender" runat="server" TargetControlID="view2" Controller="Message_Recipients" view="grid1" FilterSource="view1Extender" FilterFields="Status_ID" PageSize="5" AutoHide="Container" />
    </div>
  </div>
</asp:Content>
