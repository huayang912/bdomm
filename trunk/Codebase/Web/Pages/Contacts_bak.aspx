...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContentPlaceHolder" runat="Server">
  <table width="100%" border="0">
    ...
    <div id="view11" runat="server"></div>
      ...
      <td>
      <td width="50%" valign="top"><div factory:flow="NewRow" style="padding-top:8px" xmlns:factory="urn:codeontime:app-factory">
          <table style="width: 100%" border="0" height="100%">
            <tr>
              <td width="100%" valign="top"><div id="view12" runat="server"></div>
            ...
            <tr>
              <td width="100%" valign="top"><div id="view4" runat="server"></div>
            ...
            <tr>
              <td width="100%" valign="top"><div id="view8" runat="server"></div>
            ...
            <tr>
              <td width="100%" valign="top" bgcolor="#CCDDFF"><div id="view6" runat="server"></div>
