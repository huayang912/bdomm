    ...
    public class ControllerDataSourceDesignView : DesignerDataSourceView
    {
        ...
        public override IDataSourceViewSchema Schema
        {
            get
            {
                ...
                Stream res = GetType().Assembly.GetManifestResourceStream(String.Format("BUDI2_NS.Controllers.{0}.xml", DataController));
                if (res == null)
                	res = GetType().Assembly.GetManifestResourceStream(String.Format("BUDI2_NS.{0}.xml", DataController));
                if (res != null)
