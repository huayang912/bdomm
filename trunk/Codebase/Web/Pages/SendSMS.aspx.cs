...
public partial class Pages_SendSMS : System.Web.UI.Page
{
    ...
    {        
        if (Page.IsValid)
        {
            bool result = IsSmsServiceRunning();
    ...
    private bool SendMessage(Message message, IList<Message_Recipient> receivers)
    {
        ...
        ///TODO: UnComment the Following Line to enable Sending SMS
        ...
        {
            _ErrorMessage = "Unable to send SMS message.  SMS Service did not return the expected data.";
            return false;
        }
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //if (this.GridView1.SelectedRow.SelectedRows.Count > 0)
            //{
            ...
            //GridView1.SelectedRow.rows

            //foreach (GridViewRow r in GridView1.Rows)
            //{
            //    if(r.sele)
            //    message_RecipientsDataGridView.Rows.Remove(r);
            //}
        }
        catch (Exception ex)
        {
