...
{    
    ...
    {
        BindPageInfo();
        //Load the password in a hidden label control
        ///This cannot be done. Because there is Security issue. 
        ///Current Password will be visible in the HTML Souce without any encryption.
        ///txtHiddenPass.Text = SessionCache.CurrentUser.Password.ToString();
    }
    ...
    #region AJAX Method for change password
    /// <summary>
    /// Changes Password Through an Ajax Call
    /// </summary>
    ...
    {
        return SessionCache.CurrentUser.Password.ToString();
