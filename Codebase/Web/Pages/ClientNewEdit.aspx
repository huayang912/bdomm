<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="ClientNewEdit.aspx.cs" Inherits="Pages_ClientNew"  Title="View Clients"%>
<%@ Register Src="~/Controls/ClientControlEdit.ascx" TagName="ClientControl"  TagPrefix="uc"%>
