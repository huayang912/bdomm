    ...
    <script type="text/javascript" language="javascript">
        ...
        function SavePersonnel_Success(result) {
            if (result > 0) {
                ...
                window.location = 'PersonnelChange.aspx?ID=' + result + '&Rnd=' + GetRandomNumber(); 
            }
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageHeaderContentPlaceHolder" Runat="Server">
    <asp:Literal id="ltrHeading" runat="server">Add New Personnel</asp:Literal>
</asp:Content>
    ...
    <asp:Panel ID="pnlDetails" runat="server">
        <div id="divStep1" class="GroupBox" style="display:block;">
            <div class="FormHeader">
                <b>Personnel</b><br />
                <asp:Label ID="lblStep1Title" Text="Add New Personnel" runat="server"></asp:Label>
            </div>
            <div>
                <% if (_ID > 0) {%>
                <a href="javascript:void(0);" onclick="ShowCenteredPopUp('PersonnelEmploymentHistory.aspx?<%= AppConstants.QueryString.CONTACT_ID %>=<%= _ID.ToString() %>', 'ManageEmploymentHistory', 700, 450, true);">Employment History</a> &nbsp; &nbsp;
