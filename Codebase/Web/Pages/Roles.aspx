...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContentPlaceHolder" runat="Server">
  ...
  <div factory:flow="NewRow" style="padding-top:8px" xmlns:factory="urn:codeontime:app-factory">
    <div factory:activator="Tab|Contact Roles">
      ...
      <aquarium:DataViewExtender id="view2Extender" runat="server" TargetControlID="view2" Controller="ContactRoles" view="grid1" FilterSource="view1Extender" FilterFields="RoleID" PageSize="5" AutoHide="Container" />
    </div>
    <div factory:activator="Tab|Employment History">
      <div id="view3" runat="server"></div>
      <aquarium:DataViewExtender id="view3Extender" runat="server" TargetControlID="view3" Controller="EmploymentHistory" view="grid1" FilterSource="view1Extender" FilterFields="RoleID" PageSize="5" AutoHide="Container" />
    </div>
  </div>
</asp:Content>
