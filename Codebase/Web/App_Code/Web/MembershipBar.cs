...
{
	public class MembershipBar : Control, INamingContainer
    {
        ...
        [System.ComponentModel.DefaultValue("Welcome <b>{0}</b>, Today is {1:D}")]
        [System.ComponentModel.Description("Specifies a welcome message for an authenticated user.")]
        public string Welcome
        {
            get
            {
                if (String.IsNullOrEmpty(_welcome))
                	return "Welcome <b>{0}</b>, Today is {1:D}";
                return _welcome;
            }
            set
            {
        ...
        protected override void CreateChildControls()
        {
            ...
            if (Page.User.Identity.IsAuthenticated)
            	welcomeText = String.Format(Welcome, Page.User.Identity.Name, DateTime.Now);
            bar.Properties.Add("Welcome", welcomeText);
